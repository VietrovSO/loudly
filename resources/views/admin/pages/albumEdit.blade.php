        ...
        <div class="flex">
            <div class="w-1/3">
                <label for="images" class="w-96 h-96 album-item block relative cursor-pointer rounded-xl overflow-hidden">
                    <img id="image-preview" class="w-full h-full object-cover cursor-pointer" src="{{asset('/storage/images/albums/' . $image)}}"/>
            ...
            <div class="w-2/5 pl-10">
                <div class="mb-2">
                    ...
                    <button type="submit" class="text-white ml-2 inline-flex bg-black border border-black items-center font-semibold text-md rounded-full px-4 py-2">
                        Save
                    ...
                    <div class="flex text-md flex-col">
                        ...
                        <input type="text" name="title" required class="mt-1 text-2xl border border-black font-semibold px-5 py-2 rounded-lg focus:outline-black" placeholder="Album title" value="{{$album->title}}" />
                    </div>
                    ...
                    <div class="flex text-md flex-col mt-5">
                        ...
                        <input id="title" name="release_date" required class="mt-1 text-md h-auto border border-black font-semibold px-5 py-2 rounded-lg" placeholder="Album release date" value="{{$album->release_date}}"/>
                    </div>
                    <div class="flex text-md flex-col mt-5">
                        <label for="title">Description:</label>
                        <textarea id="title" type="text" name="description" class="mt-1 resize-y max-h-40 min-h-16 text-md h-auto border border-black px-5 py-2 rounded-lg" placeholder="Album description">{{$album->description}}</textarea>
                    </div>
